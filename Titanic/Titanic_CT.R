...
my_tree <- ctree(as.factor(Survived) ~ Pclass  + Age ,
                          data = trainData)
...
write.csv(kaggle.sub, file = "C:\\Users\\sai-g\\Desktop\\Goutham\\3.App.Multivariate Analysis\\Project\\Kaggle_CTree.csv", row.names = FALSE)